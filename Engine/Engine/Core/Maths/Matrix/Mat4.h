...
#pragma region Tools
				...
				// If it returns false, out is unchanged
...
#pragma endregion
		...
		template<typename... Arguments>
		inline engine::core::maths::Mat4 engine::core::maths::Mat4::CreateRotationMatrix(Arguments... invalidArgs)
		{
		...
		template<typename... Arguments>
		inline engine::core::maths::Mat4 engine::core::maths::Mat4::CreateRotationMatrix(EAxis axis, float angle, Arguments... rotations)
		{
